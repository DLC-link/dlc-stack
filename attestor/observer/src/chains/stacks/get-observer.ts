...
// export default async (config: ChainConfig): Promise<BlockchainInterface> => {
...
//     startListening,
//     getAllVaults: () => {
//       // TODO: Implement the getAllVaults function
//       return null; // or return [];
//     },
//     setVaultStatusFunded: (vaultUUID: string, bitcoinTransactionID: string) => {
//       return dlcManager.setVaultStatusFunded(vaultUUID, bitcoinTransactionID);
//     },
//     setVaultStatusPostClosed: (vaultUUID: string, bitcoinTransactionID: string) => {
//       return dlcManager.setVaultStatusPostClosed(vaultUUID, bitcoinTransactionID);
//     },
//   };
// };
